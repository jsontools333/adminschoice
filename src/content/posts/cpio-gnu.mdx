---
title: "cpio ( GNU )"
description: "Use this FILE-NAME instead of standard input or output."
pubDate: 2014-03-09
...
files from an archive (run in copy-in
...
accumulate. Operation modifiers valid only in copy-in mode:
...
actually extract the files Operation modifiers valid only in copy-out mode:
...
possible Operation modifiers valid in copy-in and copy-out modes:
...
directory Operation modifiers valid in copy-out and copy-pass modes:

-0, --null

A list of filenames is terminated by a null
...
Archive filename to use instead of standard input. Optional USER and HOST specify the user and host
